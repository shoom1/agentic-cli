...
- **Sidecar** — per-document structured markdown at `documents/{id}.md` generated by the LLM at ingest. Contains `Summary`, `Key Claims`, `Key Entities`. Returned by `kb_read(doc_id)` by default. Use for "what is this one paper about."
